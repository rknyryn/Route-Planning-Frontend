...
export default function DailyVoteScreen({ navigation }) {
  ...
  async function getDailyList() {
    ...
    await fetch(
      "http://route-planning-backend.azurewebsites.net/route/daily-vote/",
      requestOptions
    )
  ...
  async function saveRoute() {
    ...
    await fetch(
      "http://route-planning-backend.azurewebsites.net/algorithm/limited-car/route-save",
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
  ...
  async function getRouteList() {
    ...
    fetch(
      "http://route-planning-backend.azurewebsites.net/algorithm/limited-car/route-list",
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.containerButton}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          <TouchableOpacity style={styles.button} onPress={routeClear}>
